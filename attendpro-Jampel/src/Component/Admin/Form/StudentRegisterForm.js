...
export default function StudentRegister() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log("Form submitted:", { studentName, studentNumber, studentGender, email, contactNumber, year, stClass });
        } catch (error) {
                    ...
                    <div className="bg-white shadow-md rounded px-8 py-6">
                        <div className="flex mb-4 w-100 rounded">
                            <div className="ms-auto me-auto rounded-lg">
                                <button onClick={(e) => handleTabClick(e, 'single')} className={`py-2 px-4 ${activeTab === 'single' ? 'bg-blue-500 text-white rounded-lg' : 'bg-gray-300 text-gray-700 rounded-lg'} focus:outline-none`}>Register Student</button>
                        ...
                        <div className="mb-4">
                            {activeTab === 'single' && (
                                <form onSubmit={handleSubmit}>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2 shadow-none" htmlFor="studentName">
                                            Name
                                        </label>
                                        <input className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="studentName" type="text" placeholder="Student Name" value={studentName} onChange={(e) => setStudentName(e.target.value)} />
                                    </div>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2 shadow-none" htmlFor="studentNumber">
                                            Student Number
                                        </label>
                                        <input className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="studentNumber" type="text" placeholder="Student Number" value={studentNumber} onChange={(e) => setStudentNumber(e.target.value)} />
                                    </div>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2 shadow-none" htmlFor="studentGender">
                                            Gender
                                        </label>
                                        <input className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="studentGender" type="text" placeholder="Gender" value={studentGender} onChange={(e) => setStudentGender(e.target.value)} />
                                    </div>
                                    <div className="mb-4">
                                    ...
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2 shadow-none" htmlFor="year">
                                            Year
                                        </label>
                                        <input className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="year" type="text" placeholder="Year" value={year} onChange={(e) => setYear(e.target.value)} />
                                    </div>
                                    <div className="mb-4">
                                        <label className="block text-gray-700 text-sm font-bold mb-2 shadow-none" htmlFor="studentClass">
                                            Class
                                        </label>
                                        <input className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="studentClass" type="text" placeholder="Class" value={stClass} onChange={(e) => setStClass(e.target.value)} />
                                    </div>
